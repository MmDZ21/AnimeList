      ...
      <div className="relative h-[260px] w-full">
        ...
        <div className="z-40 h-full w-full flex flex-col justify-end relative bottom-2 items-center gap-4">
          ...
          <h2 className="text-base font-normal text-[#D3D5D9] text-center px-6">
            با خرید اشتراک ویژه می‌تونی دسترسی کاملی به کل آرشیو انیمه‌لیست و
            دانلود جهت تماشای آفلاین داشته باشی.
          </h2>
        </div>
      </div>
      <Tabs className="w-full" defaultValue="3">
        <TabsList className="w-full dark:bg-transparent border-b border-[hsla(215,20%,65%,0.24)] justify-center">
          ...
          <TabsTrigger value="3">سه ماهه</TabsTrigger>
          <TabsTrigger value="6">شش ماهه</TabsTrigger>
        </TabsList>
        <TabsContent value="1">
          <div className="flex flex-col p-4 gap-4 items-center">
            <div className="w-full max-w-[800px] h-[360px] rounded-2xl bg-transparent border border-[hsla(215,20%,65%,0.24)]">
              ...
              <div className="flex flex-col gap-4 px-6 -mt-[156px]">
                <div className="flex flex-col gap-1 z-50">
                  <p className="text-base font-bold">۳۰ روزه</p>
                  <p className="text-2xl font-black">۶۰،۰۰۰ تومان</p>
                </div>
                <div className="flex flex-col gap-2 z-50 text-base font-medium">
                  ...
                  <div className="flex gap-[10px] items-center">
                    ...
                    <p>امکان استفاده از پخش آنلاین</p>
                  </div>
                  <div className="flex gap-[10px] items-center">
                    <svg
                      width="24"
                    ...
                    <p>دانلود با ترافیک مصرفی نیم بها</p>
                  </div>
                  <div className="flex gap-[10px] items-center">
                    <svg
                      width="24"
                    ...
                    <p>سرعت بالا و بدون محدودیت در دانلود</p>
                  </div>
                </div>
                <Button className="flex gap-1 h-12 w-full">
                  <svg
                    width="25"
                    height="24"
                    viewBox="0 0 25 24"
                  ...
                  <p className="text-base font-bold">خرید اشتراک</p>
                </Button>
              </div>
            </div>
          </div>
        ...
        <TabsContent value="3">
          <div className="flex flex-col p-4 gap-4 items-center">
            <div className="w-full max-w-[800px] h-[360px] rounded-2xl bg-transparent border border-[hsla(215,20%,65%,0.24)]">
              ...
              <div className="flex flex-col gap-4 px-6 -mt-[188px]">
                <div className="flex flex-col gap-1 z-50">
                  <p className="text-base font-bold">۶۰ روزه</p>
                  <p className="text-2xl font-black">۱۲۰،۰۰۰ تومان</p>
                </div>
                <div className="flex flex-col gap-2 z-50 text-base font-medium">
                  <div className="flex gap-[10px] items-center">
                    <svg
                    ...
                    <p className="text-[#FFC107]">+ ۶ روز هدیه</p>
                  </div>
                  <div className="flex gap-[10px] items-center">
                    <svg
                      width="24"
        ...
        <TabsContent value="6">
          <div className="flex flex-col p-4 gap-4 items-center">
            <div className="w-full max-w-[800px] h-[360px] rounded-2xl bg-transparent border border-[hsla(215,20%,65%,0.24)]">
              ...
              <div className="flex flex-col gap-4 px-6 -mt-[188px]">
                <div className="flex flex-col gap-1 z-50">
                  <p className="text-base font-bold">۹۰ روزه</p>
                  <p className="text-2xl font-black">۱۸۰،۰۰۰ تومان</p>
                </div>
                <div className="flex flex-col gap-2 z-50 text-base font-medium">
                  <div className="flex gap-[10px] items-center">
                    <svg
