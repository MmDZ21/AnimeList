  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center gap-4 lg:gap-6 max-w-[1280px] pb-4 -mt-12 lg:-mt-44 z-20 lg:px-4">
        ...
        <CustomTabs defaultValue={dashboardRoutes[0].value} className="w-full lg:hidden">
          ...
          {dashboardRoutes.map((route) => (
            ...
            >
              <div className="px-4 flex flex-col gap-2 animate-fade-right"><route.content/></div>
            </CustomTabsContent>
          ))}
        </CustomTabs>

        {/* Desktop Tabs (ShadCN Tabs) */}
        <Tabs defaultValue={dashboardRoutes[0].value} className="w-full hidden lg:block">
