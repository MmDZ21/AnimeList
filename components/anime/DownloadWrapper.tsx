...
export default function DownloadWrapper({ episode }: { episode: Episode }) {
  return (
    <div className="bg-background text-base font-semibold px-4 py-3 flex justify-between rounded-lg">
      <div className="flex gap-[10px]">
        <h6 className="text-primary-500"></h6>
      ...
      <div className="flex gap-4">
        <Button className="bg-[#17212B] px-6 py-1 rounded gap-2">
