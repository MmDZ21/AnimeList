...
export default function CommentWrapper({
  ...
  comment: CommentsFragmentFragment;
}) {
            ...
            <div className="flex gap-3 items-center">
              <div className="relative size-10">
                <Image
                  ...
                  alt={comment.user?.name || "کاربر سایت"}
                  fill
          ...
          <div className="flex justify-between items-center text-[#979CA6]">
            <div className="flex gap-4 items-center">
              ...
              {(comment.replies.length > 0) && (
                <div
                  className="flex items-center cursor-pointer gap-2 text-primary-500 text-sm font-medium"
