...
function Submit() {
    ...
    return             <Button disabled={status.pending} type="submit" className="flex gap-1 h-12 w-full z-50">
    <svg
      width="25"
      height="24"
      viewBox="0 0 25 24"
    ...
    <p>خرید اشتراک</p>
    {status.pending && <Image src={"/svg/spinner.svg"} alt="pending" width={24} height={24}/>}
  </Button>
  }
