      ...
      <div className="flex justify-between">
        ...
        <div className="flex flex-col gap-3">
          <div className="w-[350px] h-[400px] rounded-2xl bg-background">
            ...
            <form action={membership} className="flex flex-col gap-3 items-center px-6 rounded-md -mt-10 z-50">
              ...
              <Button className="flex gap-1 h-12 w-full z-50" type="submit">
                <svg
                  width="25"
                  height="24"
                  viewBox="0 0 25 24"
